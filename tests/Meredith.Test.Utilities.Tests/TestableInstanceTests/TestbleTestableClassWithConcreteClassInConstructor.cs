...
{
    [TestFixture]
    public class TestableWrapperForTestableClassWithConcreteClassInConstructor
    {
        [Test]
        public void It_Should_Use_The_Constructor_Despite_Abstract_Parameter()
        {
            ...
            var myClass = new TestableInstance<TestableClassWithConcreteClassInConstructor>();

            myClass.DependsOn<Credentials>()
