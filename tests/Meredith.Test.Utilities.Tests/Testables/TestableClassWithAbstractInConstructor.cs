...
{
    public class TestableClassWithAbstractInConstructor
    {
        private readonly ICredentials _credentials;
        private readonly ICrossCuttingConcern _crossCuttingConcern;

        public TestableClassWithAbstractInConstructor(CredentialsBase credentials, ICrossCuttingConcern crossCuttingConcern)
        {
